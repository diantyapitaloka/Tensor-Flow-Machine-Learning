...
- Debouncing and Prediction Smoothing: A temporal smoothing algorithm, such as a rolling average or a consecutive-frame threshold, was implemented on the inference script to prevent "flickering" predictions cause by momentary motion blur or transitional hand positions.
