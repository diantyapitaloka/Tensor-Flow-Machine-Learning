...
- Debouncing and Prediction Smoothing: A temporal smoothing algorithm, such as a rolling average or a consecutive-frame threshold, was implemented in the inference script to prevent "flickering" predictions caused by momentary motion blur or transitional hand positions.
